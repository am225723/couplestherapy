...
dashboardCustomizationRouter.get("/couple/:coupleId", async (req: Request, res: Response) => {
  try {
    ...
    if (!data) {
      ...
      return res.json({
        couple_id: coupleId,
        widget_order: ["weekly-checkin","love-languages","gratitude","shared-goals","conversations","love-map","voice-memos","calendar","rituals"],
        enabled_widgets: {
          "weekly-checkin": true,
          "love-languages": true,
          "gratitude": true,
...
dashboardCustomizationRouter.post("/couple/:coupleId", async (req: Request, res: Response) => {
  try {
    const { coupleId } = req.params;
    ...
    const { data, error } = await supabaseAdmin
      ...
      .upsert({
        couple_id: coupleId,
        therapist_id,
        widget_order: widget_order || ["weekly-checkin","love-languages","gratitude","shared-goals","conversations","love-map","voice-memos","calendar","rituals"],
