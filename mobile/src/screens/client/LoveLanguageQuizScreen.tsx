...
const questions = [
  { id: 1, text: 'I feel most loved when...', options: [
  ...
  { id: 2, text: 'I appreciate it most when...', options: [
  ...
  { id: 3, text: 'My ideal date would be...', options: [
  ...
  { id: 4, text: 'I feel disconnected when...', options: [
  ...
  { id: 5, text: 'I show love by...', options: [
...
type Language = 'words_of_affirmation' | 'quality_time' | 'receiving_gifts' | 'acts_of_service' | 'physical_touch';
      ...
      <ScrollView style={styles.container}>
        <View style={styles.content}>
          ...
          <Card style={styles.resultsCard}>
            ...
            <Text style={styles.primaryLanguage}>{existingResult.primary_language}</Text>
            
            <Text style={styles.secondaryLabel}>Secondary Love Language</Text>
            <Text style={styles.secondaryLanguage}>{existingResult.secondary_language}</Text>

            <View style={styles.scoresSection}>
              <Text style={styles.scoresTitle}>Breakdown</Text>
              <View style={styles.scoreRow}>
                <Text style={styles.scoreLabel}>Words of Affirmation:</Text>
                <Text style={styles.scoreValue}>{existingResult.words_of_affirmation}</Text>
              </View>
              <View style={styles.scoreRow}>
                <Text style={styles.scoreLabel}>Quality Time:</Text>
                <Text style={styles.scoreValue}>{existingResult.quality_time}</Text>
              </View>
              <View style={styles.scoreRow}>
                <Text style={styles.scoreLabel}>Receiving Gifts:</Text>
                <Text style={styles.scoreValue}>{existingResult.receiving_gifts}</Text>
              </View>
              <View style={styles.scoreRow}>
                <Text style={styles.scoreLabel}>Acts of Service:</Text>
                <Text style={styles.scoreValue}>{existingResult.acts_of_service}</Text>
              </View>
              <View style={styles.scoreRow}>
                <Text style={styles.scoreLabel}>Physical Touch:</Text>
                <Text style={styles.scoreValue}>{existingResult.physical_touch}</Text>
              </View>
            </View>
        ...
        <View style={styles.content}>
          ...
          <Card>
            <Text style={styles.description}>
              This quiz will help you understand your primary and secondary love languages. 
              Answer honestly about what makes you feel most loved and valued in your relationship.
            </Text>
...
const styles = StyleSheet.create({
  ...
  languageItem: { ...typography.body, color: colors.text, marginBottom: spacing.xs },
  progressBar: {
    height: 4,
  ...
  questionNumber: { ...typography.bodySmall, color: colors.textSecondary, marginBottom: spacing.sm },
  ...
  primaryLabel: { ...typography.bodySmall, color: colors.textSecondary, marginBottom: spacing.xs },
  primaryLanguage: { ...typography.h3, color: colors.primary, marginBottom: spacing.lg },
  secondaryLabel: { ...typography.bodySmall, color: colors.textSecondary, marginBottom: spacing.xs },
  secondaryLanguage: { ...typography.h5, color: colors.secondary, marginBottom: spacing.lg },
  scoresSection: { marginVertical: spacing.lg },
  scoresTitle: { ...typography.h6, color: colors.text, marginBottom: spacing.sm },
