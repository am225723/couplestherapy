...
export default function FinancialToolkitScreen() {
  ...
  const [selectedTab, setSelectedTab] = useState<'values' | 'goals' | 'discussions'>('values');
        ...
        {selectedTab === 'values' && (
          <View>
            <Card style={styles.addCard}>
              <Text style={styles.cardTitle}>What do you value about money?</Text>
              <TextInput
                style={styles.input}
                value={newValue}
              ...
              <View>
                ...
                {values.map((value: any) => (
                  <Card key={value.id} style={styles.itemCard}>
                    <Text style={styles.itemText}>{value.value_description}</Text>
                    <Text style={styles.itemMeta}>
                      Added by {value.created_by === profile?.id ? 'you' : 'partner'}
                    </Text>
                  </Card>
                ))}
              </View>
        ...
        {selectedTab === 'discussions' && (
          <Card>
            ...
            <View style={styles.promptList}>
              <Text style={styles.promptText}>• How did your family handle money growing up?</Text>
              <Text style={styles.promptText}>• What are your biggest financial fears?</Text>
              <Text style={styles.promptText}>• What financial goals excite you most?</Text>
              <Text style={styles.promptText}>• How should we make big purchase decisions?</Text>
              <Text style={styles.promptText}>• What does financial security mean to you?</Text>
            </View>
          </Card>
        )}
      </View>
...
const styles = StyleSheet.create({
  ...
  itemText: { ...typography.body, color: colors.text, marginBottom: spacing.xs },
