...
export default function CoupleJournalPage() {
  ...
  const [visibility, setVisibility] = useState<
    "private" | "shared_with_partner" | "shared_with_therapist"
  >("shared_with_partner");
      ...
      <div className="max-w-5xl mx-auto py-12 space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-3xl font-bold" data-testid="title-journal">
                Shared Couple Journal
              </h1>
              <p className="text-muted-foreground">
                Document your relationship journey together
              </p>
            </div>
          </div>
          <Button
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Select
                    value={mode}
                    onValueChange={(v) => setMode(v as "joint" | "individual")}
                  >
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="shared_with_partner">
                        Shared with Partner
                      </SelectItem>
                      <SelectItem value="shared_with_therapist">
          ...
          <Card data-testid="card-empty-state">
            <CardContent className="flex flex-col items-center justify-center py-16">
              ...
              <p className="text-muted-foreground text-center mb-6">
                Start documenting your relationship journey by creating your
                first journal entry
              </p>
              <Button
                onClick={() => setShowNewEntry(true)}
            ...
            >
                ...
                <div className="flex items-start justify-between">
                  <div className="space-y-1 flex-1">
                    <div className="flex items-center gap-2 flex-wrap">
                      <Badge
                        variant={
                          entry.mode === "joint" ? "default" : "secondary"
                        }
                        data-testid={`badge-mode-${entry.id}`}
                      >
                        {entry.mode === "joint" ? (
                      ...
                      <Badge
                        variant="outline"
                        data-testid={`badge-visibility-${entry.id}`}
                      >
                    ...
                    <div className="flex items-center gap-2 text-sm text-muted-foreground">
                      ...
                      <span>•</span>
                      <span data-testid={`text-author-${entry.id}`}>
                        {entry.createdBy}
                      </span>
                    </div>
                  </div>
              ...
              <CardContent>
                <p
                  ...
                  data-testid={`text-content-${entry.id}`}
                >
                  {entry.content}
                </p>
              </CardContent>
