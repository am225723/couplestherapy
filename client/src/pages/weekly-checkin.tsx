      ...
      <div className="max-w-3xl mx-auto">
        ...
        <Alert className="mb-6 border-primary/20 bg-primary/5">
          ...
          <AlertDescription className="text-sm">
            Your responses are completely private. Your partner cannot see what you write here.
            Only your therapist can view both check-ins to better support your relationship.
          </AlertDescription>
        </Alert>
            ...
            <CardContent className="space-y-8">
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-2xl font-bold text-primary" data-testid="text-connectedness-value">
                    {connectedness[0]}
                  </span>
                </div>
                <div className="flex items-center gap-4">
                  ...
                  <Slider
                    ...
                    className="flex-1"
                  />
                  <span className="text-sm text-muted-foreground">Very connected</span>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-2xl font-bold text-secondary-foreground" data-testid="text-conflict-value">
                    {conflict[0]}
                  </span>
                </div>
                <div className="flex items-center gap-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="appreciation">
                  What is one thing your partner did this week that you truly appreciated?
                </Label>
                <Textarea
                  id="appreciation"
              ...
              <div className="space-y-2">
                <Label htmlFor="regrettable">
                  What was one moment of disconnection or a 'regrettable incident' this week?
                </Label>
                <Textarea
                  id="regrettable"
              ...
              <div className="space-y-2">
                <Label htmlFor="need">
                  What is one specific thing you need from your partner next week?
                </Label>
                <Textarea
                  id="need"
