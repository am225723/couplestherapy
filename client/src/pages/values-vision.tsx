...
export default function ValuesVisionPage() {
  ...
  const createDreamMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({
        title: "Dream Added",
        description: "Your dream has been shared.",
      });
      setNewDream({
        dream_text: "",
        category: "shared",
  ...
  const createValueMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({
        title: "Value Added",
        description: "Your core value has been added.",
      });
  ...
  const honorDreamMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({
        title: "Dream Honored",
        description: "You've acknowledged your partner's dream.",
      });
    },
  });
    ...
    <div className="container mx-auto p-6 space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-2">
          Share your dreams, define your values, and create a shared vision for
        ...
        <CardContent className="space-y-4">
          <div className="space-y-3">
            <Textarea
              ...
              onChange={(e) =>
                setNewDream({ ...newDream, dream_text: e.target.value })
              }
            />
            ...
            <div className="grid grid-cols-2 gap-3">
              <select
                ...
                onChange={(e) =>
                  setNewDream({ ...newDream, category: e.target.value })
                }
              ...
              <select
                ...
                onChange={(e) =>
                  setNewDream({ ...newDream, time_horizon: e.target.value })
                }
                className="border rounded-md p-2"
              >
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-2">
                        <Badge data-testid={`badge-horizon-${dream.id}`}>
                          {
                            TIME_HORIZONS[
                              dream.time_horizon as keyof typeof TIME_HORIZONS
                            ]
                          }
                        </Badge>
                        <Badge
                        ...
                        >
                          {
                            DREAM_CATEGORIES[
                              dream.category as keyof typeof DREAM_CATEGORIES
                            ]
                          }
                        </Badge>
                      </div>
                      <p
                        className="text-sm"
                        data-testid={`text-dream-${dream.id}`}
                      >
                        {dream.dream_text}
                      </p>
                      <p
                        className="text-xs text-muted-foreground mt-1"
                        data-testid={`text-date-${dream.id}`}
                      >
                        {format(new Date(dream.created_at), "MMM d, yyyy")}
                      </p>
                    </div>
                    {dream.author_id !== profile?.id &&
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Define the values that guide your relationship
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-3">
            <Input
              ...
              onChange={(e) =>
                setNewValue({ ...newValue, value_name: e.target.value })
              }
            />
            ...
            <Textarea
              ...
              onChange={(e) =>
                setNewValue({ ...newValue, definition: e.target.value })
              }
            />
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Create a visual representation of your shared future
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-3">
            <Input
              ...
              onChange={(e) =>
                setNewVisionItem({ ...newVisionItem, title: e.target.value })
              }
            />
            ...
            <Button
              ...
              disabled={
                createVisionItemMutation.isPending || !newVisionItem.title
              }
              className="w-full"
            >
              {createVisionItemMutation.isPending
                ? "Adding..."
                : "Add to Vision Board"}
            </Button>
          </div>
                ...
                <CardContent>
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    <Badge
                      variant="outline"
                      className="text-xs"
                      data-testid={`badge-horizon-${item.id}`}
                    >
                      {
                        TIME_HORIZONS[
                          item.time_horizon as keyof typeof TIME_HORIZONS
                        ]
                      }
                    </Badge>
                  </div>
