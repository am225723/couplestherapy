...
const SESSION_TOOLS: SubNavItem[] = [
  {
    ...
    label: "Session Notes",
    icon: FileText,
    description: "Document your sessions",
  },
  {
    id: "checkins",
    label: "Weekly Check-Ins",
    icon: CheckCircle,
    description: "View partner check-ins",
  },
  {
    id: "analytics",
    label: "AI Analytics",
...
const CLIENT_MANAGEMENT: SubNavItem[] = [
  {
    ...
    icon: Sliders,
    description: "Customize client view",
  },
  {
    id: "prompts",
    label: "Client Prompts",
    icon: PenLine,
    description: "Send reflection prompts",
  },
  {
    id: "languages",
  ...
  },
  {
    ...
    icon: Users,
    description: "Attachment patterns",
  },
  {
    id: "enneagram",
    label: "Enneagram",
  ...
  },
  {
    ...
    label: "Love Map",
    icon: Map,
    description: "Relationship knowledge",
  },
];
...
const COMMUNICATION: SubNavItem[] = [
  ...
  },
  {
    ...
    icon: PenLine,
    description: "Client reflections",
  },
  {
    id: "conversations",
    label: "Hold Me Tight",
    icon: Heart,
    description: "Structured dialogues",
  },
  {
    id: "goals",
    label: "Shared Goals",
  ...
  },
  {
    ...
    label: "Rituals",
    icon: Book,
    description: "Connection rituals",
  },
  {
    id: "journal",
...
const OVERVIEW_ITEMS: SubNavItem[] = [
  ...
  {
    id: "therapist-thoughts",
    label: "Therapist Thoughts",
    icon: Lightbulb,
    description: "Notes & todos",
  },
];
