...
export const attachmentQuestions: AttachmentQuestion[] = [
  {
    id: 1,
    question_text:
      "I find it relatively easy to get close to others emotionally.",
  ...
  },
  {
    id: 12,
    question_text:
      "I get uncomfortable when people want to be very close emotionally.",
    attachment_category: "secure",
    reverse_scored: true,
  },
  {
  ...
  },
  {
    id: 14,
    question_text:
      "I sometimes feel confused about my feelings in relationships.",
  ...
  },
  {
    id: 16,
    question_text:
      "I want to be completely emotionally intimate but find others are reluctant.",
    attachment_category: "anxious",
    reverse_scored: false,
  },
  {
  ...
  },
  {
    id: 18,
    question_text:
      "I sometimes feel like I want closeness and also want to pull away at the same time.",
    attachment_category: "disorganized",
    reverse_scored: false,
  },
  {
  ...
  },
  {
    id: 25,
    question_text:
      "I sometimes feel relationships are confusing and unpredictable.",
    attachment_category: "disorganized",
    reverse_scored: false,
  },
  {
...
export function calculateAttachmentStyle(responses: {
  ...
  const normalizedScores = {
    secure:
      categoryCounts.secure > 0
        ? Math.round((scores.secure / (categoryCounts.secure * 5)) * 100)
        : 0,
    anxious:
      categoryCounts.anxious > 0
        ? Math.round((scores.anxious / (categoryCounts.anxious * 5)) * 100)
        : 0,
    avoidant:
      categoryCounts.avoidant > 0
        ? Math.round((scores.avoidant / (categoryCounts.avoidant * 5)) * 100)
        : 0,
    disorganized:
      categoryCounts.disorganized > 0
        ? Math.round(
            (scores.disorganized / (categoryCounts.disorganized * 5)) * 100,
          )
        : 0,
  };
